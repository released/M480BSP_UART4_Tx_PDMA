...
#line 175 "..\\main.c"
    ...
    {
        if((((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & ((1 << (5))) ) == ((1 << (5)))  )
        {
             
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = (((1 << (5))))));
            
			
            (((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL))))->INTEN &= ~((0x1ul << (14))));
...
void UART_TX_PDMA(uint8_t* Datain , uint16_t len)
{
    ...
    PDMA_SetTransferCnt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(5), 0x00000000UL, len);
     
    PDMA_SetTransferAddr(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(5), (uint32_t) (&Datain[0]), 0x00000000UL, (uint32_t) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL) , 0x00000C00UL);
     

    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(5), 12UL, (0UL), 0);
...
#line 250 "..\\main.c"
    ...
    while(!((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL))))->FIFOSTS & (0x1ul << (28))) >> (28)));
...
void UART_PDMA_Init(void)
{
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), ((1 << (5))));

    PDMA_SetBurstType(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(5), 0x00000004UL, 0x00000000UL);
     
    ((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[(5)].CTL |= (0x1ul << (7));

	(((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x34000UL))))->INTEN &= ~((0x1ul << (14))));        


    PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (5), 0x00000000UL);
...
void create_buffer(void)
{
    ...
    for (i = 0 ; i < ((32)/2) ; i++)
    {
        tBuffer[i*2+0] = ((unsigned char)((i)>>8));
        tBuffer[i*2+1] = ((unsigned char)((i)&0xFF));
    }    
}
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(28UL<<20) |(3UL<<18) |(0xFUL<<10) |(8UL<<5) |(20UL<<0)));
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(28UL<<20) |(3UL<<18) |(0xFUL<<10) |(8UL<<5) |(20UL<<0)), (0x3UL << (28)), (((1) - 1UL) << (8)));

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL &= ~((0xful << (24)) | (0xful << (28)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL |= ((0x05UL<<(24)) | (0x05UL<<(28)));
